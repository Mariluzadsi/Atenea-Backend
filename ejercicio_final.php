<?php
/*  Para llamar Base de Datos*/
include 'tabla_datos/conexion.php';
$query = mysqli_query($conexion, "SELECT * FROM alumnos ") /* Realizar una consulta mediante una sentencia*/
...
<head>
    ...
    <!--Para conectar la tabla se llama estos dos archivos  -->
...
<div class="wrapper"><!---------------------------------Este Wrapper es codigo de internet ya terminado------------------------->
    <div class="container">
    <div class="filter">
    <div class="row">
    <div class="col-sm-4">
